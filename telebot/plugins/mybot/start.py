    ...
    if LOAD_MYBOT == "False":
        ...
        if BOT_PIC:
            await tgbot.send_file(event.chat_id,
                                  ...
                                  buttons=[
                                      [Button.url(
                                          "Denver", url="https://t.me/Denver02")],
                                      [Button.inline(
            ...
            await tgbot.send_message(event.chat_id,
                                     ...
                                     buttons=[
                                         [Button.url(
                                             "TeleBot", url="https://github.com/Denver-userbot/userbot-d")],
                                         [Button.inline(
                                             "Whats this?", data="telebot")]
                                     ]
                                     )
...
async def settings(event):
    await event.edit("Browse through the available options:",
                     buttons=[
                         [(Button.url("Repository", url="https://github.com/xx/vv")),
                          (Button.url("Deploy", url="https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2Fxxx%2FTeleBot%2F&template=https%3A%2F%2Fgithub.com%2Fxditya%2FTeleBot"))],
                         [Button.url("Support",
                                     url="https://t.me/TeleBotSupport")]
                     ])
